...
INSERT INTO empleado_r1 VALUES ('2','EAAA930609HMSSLL00','Jose Alejandro', 'Bonilla', 'Leyva', '13/07/1984');
...
ALTER TABLE Tipo_de_Planta_R1 ADD CONSTRAINT CHT_genero CHECK (GENERO IN('Haworthia','Gasteria','Astrophytum','Ariocarpus'));
ALTER TABLE Tipo_de_Planta_R1 ADD CONSTRAINT CHT_nombre CHECK (Nombre_del_tipo_de_planta IN('Haworthia','Gasteria','Astrophytum','Ariocarpus'));
...
ALTER TABLE REGISTRO_R1 ADD CONSTRAINT CHR_GENERO CHECK (GENERO IN('Haworthia','Gasteria','Astrophytum','Ariocarpus'));
...
ALTER TABLE EMPLEADO_R1 ADD CONSTRAINT CHE_Edad CHECK (extract(year from age(Fecha_de_nacimiento)) > 21);
...
ALTER TABLE Semillas_Germinadas_R1 ADD CONSTRAINT CHSG_Origen CHECK (Origen IN ('America','Africa'));
